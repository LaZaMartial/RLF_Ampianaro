  ...
  <div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8 mt-6">
    ...
    <form method="POST" name="form1" action="Eleve.jsp" class="space-y-6">
      ...
      <div>
        ...
        <input type="date" name="dateNaissance" value="<jsp:getProperty name='EleveBean' property='dateNaissance'/>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#c38c9b]" />
      </div>
      <div>
