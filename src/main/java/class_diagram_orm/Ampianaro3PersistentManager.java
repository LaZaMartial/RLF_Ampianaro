...
public class Ampianaro3PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ampianaro3";
	...
	private Ampianaro3PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Ampianaro3PersistentManager();
		}
