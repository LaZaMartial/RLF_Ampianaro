...
import org.orm.*;
public class ListAmpianaro2Data {
	...
	public static void main(String[] args) {
		try {
			ListAmpianaro2Data listAmpianaro2Data = new ListAmpianaro2Data();
			try {
				listAmpianaro2Data.listTestData();
				//listAmpianaro2Data.listByCriteria();
			}
			finally {
